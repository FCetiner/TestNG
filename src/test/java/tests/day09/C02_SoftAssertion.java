...
public class C02_SoftAssertion {
    ...
    public void test01(){
       ...
       driver.navigate().back();    //guveli degil uyarisini geciyor
       ...
       driver.findElement(By.xpath("//strong[text()='Online Banking']")).click();
        ...
        System.out.println("Hard assertion olsaydi ve ilk assert fail olsaydi bu method calismazdi");
        ...
        softAssert.assertAll();     //fail olan methodlar bu noktaya kadar calisir
